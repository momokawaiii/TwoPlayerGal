...
transform rr(t=0.15):
    ...
    block:
        ...
        repeat
#疑问
transform why_alt(x=880, y=375):
    xcenter x+100  # 初始位置向右移动
    ycenter y-50
    zoom 0.8
    alpha 0.00
    subpixel True
    ...
    parallel:
        easeout_bounce 0.13 xcenter x+98  # 调整动画中的 xcenter 值
        easeout_bounce 0.13 xcenter x+108
        repeat
    ...
    parallel:
        linear 0.5 ycenter y + 50  # 向下平移 50 像素
image why11:
...
transform sinkwater(x=640):
    xcenter x+391 ycenter 265 zoom 0.6 alpha 0.00 subpixel True
    parallel:
...
image rush11:
    ...
    xcenter 970 ycenter 300 zoom 0.67 alpha 1.00 subpixel True
    pause 0.1
    "liluo_common/common/facial/amazing_2.png"
    xcenter 1050 ycenter 280 zoom 0.67 alpha 1.00 subpixel True
    pause 0.1
    repeat
    time 1.0
    rush
...
image happy11:
    ...
    xcenter 750 ycenter 210 zoom 0.67 alpha 1.00 subpixel True
    pause 0.4
    
    "liluo_common/common/facial/happy_2.png"
    xcenter 730 ycenter 180 zoom 0.67 alpha 1.00 subpixel True
    pause 0.4 
    repeat
    time 2.0
    rush
image happy21:
    "liluo_common/common/facial/happy_1.png"
    xcenter 500 ycenter 500 zoom 0.67 alpha 1.00 subpixel True
    pause 0.4
    "liluo_common/common/facial/happy_2.png"
    xcenter 640-125+240 ycenter 150+190 zoom 0.67 alpha 1.00 subpixel True
    pause 0.4
    repeat
    time 2.0
    rush
...
transform angry(x=640):
    xcenter x+100 ycenter 250 zoom 0.5 alpha 0.00 subpixel True
    parallel:
...
transform steam(x=640):
    xcenter x+50 ycenter 290 zoom 0.6 alpha 0.00 subpixel True
    easein 0.3 xcenter x+150 ycenter 210 alpha 1.00
    easein 1.0
...
transform munote1(x=640):
    xcenter x+800 ycenter 200+450 zoom 0.35 alpha 0.00 rotate 40 subpixel True
    parallel:
...
transform floweralt(x=640):
    xcenter x ycenter 360 zoom 0.2 alpha 0.00 subpixel True
    parallel:
...
transform flicker:
    ...
    alpha 0.0
    0.1
    xcenter 960  # 居中（适用于1920x1080屏幕）
    ycenter 540  # 居中（适用于1920x1080屏幕）
    repeat
