...
## 游戏内文本使用的字体。
define gui.text_font = "ai.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "ysy.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "ZhuqueFangsong-Regular.ttf"
...
## 来居中。
define gui.name_xpos = 705
define gui.name_ypos = -170
...
# 2. 往上提，让第一行字出现在白色框较宽的上半部分
define gui.dialogue_ypos = -115

# 3. 宽度看起来还可以，暂时不动，如果太宽再减小
define gui.dialogue_width = 666
...
define gui.choice_button_text_size = 29
...
define gui.history_name_xpos = 420
